    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by:
                <span class="label label-primary">Rizx Official Store</span>
                <span class="label label-success">@rizxofficial</span>
                <span class="label label-info">@rizxofficialinfo</span>
            </p>
        </div>
        @else
...
sed -i "s|@rizxofficial|${CONTACT_TELEGRAM}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|Protected by: Rizx Official Store|Protected by: ${BRAND_NAME}|g" "$INDEX_FILE" 2>/dev/null || true
