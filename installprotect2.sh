...
class UserController extends Controller
{
    ...
    public function view(Request $request, User $user): View
    {
        ...
        if ((int) $request->user()->id !== 1) {
            abort(403, '✖️ Akses ditolak - protect by Rizx Official Store');
        }
    ...
    public function delete(Request $request, User $user): RedirectResponse
    {
        ...
        if ((int) $request->user()->id !== 1) {
            throw new DisplayException("❌ 𝖺𝗄𝗌𝖾𝗌 𝖽𝗂𝗍𝗈𝗅𝖺𝗄 𝗉𝗋𝗈𝗍𝖾𝖼𝗍 𝖻𝗒 Rizx Official Store");
        }
        // ============================================
    ...
    public function update(UserFormRequest $request, User $user): RedirectResponse
    {
        ...
        foreach ($restrictedFields as $field) {
            if ($request->filled($field) && (int) $request->user()->id !== 1) {
                throw new DisplayException("⚠️ 𝖺𝗄𝗌𝖾𝗌 𝖽𝗂𝗍𝗈𝗅𝖺𝗄 𝗉𝗋𝗈𝗍𝖾𝖼𝗍 𝖻𝗒 Rizx Official Store");
            }
        }
        ...
        if ((int) $request->user()->id !== 1) {
            ...
            if ($inputAdmin !== null && (bool) $inputAdmin !== (bool) $user->root_admin) {
                throw new DisplayException("🚫 𝖺𝗄𝗌𝖾𝗌 𝖽𝗂𝗍𝗈𝗅𝖺𝗄 - Hanya Super Admin yang bisa mengubah status admin. Protect by Rizx Official Store");
            }
        }
        // ====================================================
...
sed -i "s|protect by Rizx Official Store|${BRAND_TEXT}|g" "$REMOTE_PATH" 2>/dev/null || true
